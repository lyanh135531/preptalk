              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-ink">
                    {props.storedInterview.session.candidateName}
                  </p>
                  <p className="text-xs text-slate-400">
                    {props.storedInterview.session.role} ·{" "}
                    {props.storedInterview.history.length} questions answered
                  </p>
                </div>
              </div>
              <button
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-14">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold font-display leading-tight text-ink">
            ...
            <span className="relative">
              ...
              >
                {typedText.length > fullHeadline.length
                  ? "live AI feedback"
                  : ""}
              </span>
            ...
            <div className="animate-fade-in-up mt-5">
              ...
              <div className="mt-5 flex items-center justify-center gap-4 text-xs text-slate-500">
                <span className="flex items-center gap-1.5">
                  <Zap size={12} className="text-amber-400" /> Real-time AI
                </span>
                <span className="flex items-center gap-1.5">
                  <Mic size={12} className="text-cyan-400" /> Voice Practice
                </span>
                <span className="flex items-center gap-1.5">
                  <Headphones size={12} className="text-indigo-400" /> Instant
                  Review
                </span>
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              {step === 1 && (
                <div className="animate-fade-in-up">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      props.onCandidateNameChange(event.target.value)
                    }
                  ...
                  <p className="mt-1.5 text-xs text-slate-500">
                    This helps the AI personalize your interview experience.
                  </p>
                </div>
              )}
              ...
              {step === 2 && (
                <div className="animate-fade-in-up">
                  ...
                  <select
                    className="w-full rounded-2xl custom-input px-5 py-3 text-base text-ink shadow-sm focus:shadow-glow transition-shadow"
                    value={props.selectedRole}
                    onChange={(event) =>
                      props.onSelectedRoleChange(event.target.value)
                    }
                    autoFocus
                  >
                  ...
                  {props.selectedRole === customRoleValue && (
                    <div className="mt-3 animate-fade-in">
                      <input
                        ...
                        onChange={(event) =>
                          props.onCustomRoleChange(event.target.value)
                        }
                        autoFocus
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      <button
                        ...
                        onClick={() =>
                          props.onYearsOfExperienceChange(opt.value)
                        }
                      >
              ...
              {props.errorMessage !== null && (
                <div
                  className="mt-4 rounded-xl border border-rose-500/20 bg-rose-950/20 px-4 py-3 text-xs leading-6 text-rose-300 animate-shake"
                  role="alert"
                >
                  {props.errorMessage}
                </div>
              ...
              {/* Navigation */}
              <div
                className={`flex items-center justify-between gap-3 ${step === 1 ? "mt-5" : "mt-6"}`}
              >
                {step > 1 ? (
                  <button
            ...
            >
              <p className="text-xs text-slate-500">
                ...
                candidates who practiced with PrepTalk
              </p>
            </div>
          </div>
        ) : null}
